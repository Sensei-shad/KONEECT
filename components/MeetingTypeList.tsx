...
const MeetingTypeList = () => {
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      />
      <HomeCard
        img={getIcon('/icons/recordings-dark.svg')}
      ...
      />
      <HomeCard
        img={getIcon('/icons/join-meeting')}
        title="Join Meeting"
      ...
      {!callDetails ? (
        ...
        <MeetingModal
          ...
          image={getIcon('/icons/checked')}
          buttonIcon={getIcon('/icons/copy')}
